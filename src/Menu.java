...
public class Menu {
    ...
    private static String[] menuArray = {null, "Acey Ducey", "Bagels", "Batnum", "Bombs Away", "Bombardment", "Dice", "Flip Flop", "Guess",
            "Name", "Pizza", "Rock, Paper, Scissors", "Sine Wave", "Stars", "War", "quit"};
